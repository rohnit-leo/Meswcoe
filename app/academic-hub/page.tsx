...
import { BookOpen, FileText, Briefcase, TrendingUp, Clock, CheckCircle, Users, Award } from "lucide-react"
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <div className="bg-gradient-to-r from-cyan-600 to-blue-600 text-white py-12">
        <div className="container mx-auto px-4">
          <h1 className="text-5xl font-bold mb-4">Academic Hub</h1>
          <p className="text-xl text-cyan-100">
            Track assignments, projects, activities, and monitor your academic progress in real-time
          </p>
        </div>
      </div>
